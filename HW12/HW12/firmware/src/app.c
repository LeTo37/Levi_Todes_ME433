...
void APP_Tasks(void) {
    ...
    static int8_t xmouse;
    static int8_t ymouse;
    static short IMUdata[7];
    ...
    switch (appData.state) {
        ...
        case APP_STATE_MOUSE_EMULATE:
            ...
            IMU_read(IMUdata);
            xmouse = (int8_t) (((float) IMUdata[4]*100.0 / 32768.0) / 3);
            ymouse = (int8_t) (((float) IMUdata[5]*100.0 / 32768.0) / 3);
            sprintf(message, "X: %4d", (xmouse));
            LCD_drawString(message, 28, 22, ILI9341_BLUE, ILI9341_GREENYELLOW);
            sprintf(message, "Y: %4d", (ymouse));
            LCD_drawString(message, 28, 42, ILI9341_GREENYELLOW, ILI9341_BLUE);
